   ...
   <script>
    $(document).ready(function(){
        ...
        $('#DoctorForm').submit(function(e){
            ...
            const date ={user_id:user_id,special:specialization,availability:availability,consultation:consultation_fee};
        ...
        //         $("#edit_doctor_id").append(`<option value="${user.user_id}" ${selected}>${user.fullName}</option>`);
        //       });
        //     }
        //   });
        ...
        //         $("#edit_consultation").val(selectedFee ? selectedFee : ""); // Set Fee in Input Field
        //     });
        ...
        //     $('#edit_doctor_id').val(edit_doctor_id);
      ...
      //         if (response.Users) {
      //             response.Users.forEach(user => {
      //                 const selected = user.user_id === edit_doctor_id ? 'selected' : '';
      //                 // Append doctor option with data-fee
      //                 $("#edit_doctor_id").append(`<option value="${user.user_id}" data-fee="${user.consultation_fee}" ${selected}>${user.fullName}</option>`);
      //             });
      //         }
      ...
      $(document).on('click', '.editBtn', function(e) {
        ...
        $(document).on('click','.deleteBtn',function(e){
            ...
            if(confirm('are you sure delete data')){
                // alert(userid);
                $.post('doctorOperation.php?url=DeleteDoctor',
