                        ...
                        <span arial-hidden="true">&times;</span>
                          ...
                          <form id="edit_appointmentForm">
                            <div class="form-group">
                                ...
                                <select id="edit_patient_id" name="edit_patient_id" class="form-control">
                                    <option value=""></option>
                                    <!-- Patients will be loaded here -->
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="doctor_id">Doctor</label>
                                <select id="edit_doctor_id" name="edit_doctor_id" class="form-control">
                                    <option value=""></option>
                                    <!-- Doctors will be loaded here -->
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="appointment_date">Appointment Date</label>
                                <input type="datetime-local" id="edit_appointment_date" name="edit_appointment_date" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="edit_appointmentStatus" id="edit_appointmentStatus" class="form-control">
                                  <option value="pending">pending</option>
    ...
    <script>
      $(document).ready(function(){
        ...
        $(document).on('click', '.editBtn', function (e) {
          ...
          //     if (response.Patients) {
          //         response.Patients.forEach(patient => {
          //             const selected = patient.patient_id == patient_id ? 'selected' : '';
          ...
          //     if (response.Doctors) {
          //         response.Doctors.forEach(doctor => {
          //             const selected = doctor.doctor_id == doctor_id ? 'selected' : '';
          ...
          //           const selected = ps == payment_status ? 'selected' : '';
          //           $("#edit_appointmentStatus").append(
          ...
          //           const selected = st == edit_status ? 'selected' : '';
          //           $("#edit_status").append(
          ...
          //     let selectedFee = $("#edit_doctor_id").find(":selected").data("fee");
          //     $("#edit_consultation_fee").val(selectedFee ? selectedFee : "");
          // });
