                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="edit_passenger_id" id="edit_passenger_id" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="edit_flight_id" id="edit_flight_id" readonly>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="edit_seat_number" name="edit_seat_number" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="password">Booking Date </label>
                                                <input type="datetime-local" class="form-control" id="edit_booking_date" name="edit_booking_date" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
