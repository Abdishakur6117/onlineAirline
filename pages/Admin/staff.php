        ...
        <div class="content-wrapper">
          <div class="body">
              <!-- <div class="card"> -->
                <!-- <div class="card-body"> -->
                  <h2>Staff Form</h2>
                  <button type="button" class="btn btn-primary at-3" id="insertModal">Add Staff</button>
                  <br>
                  <br>
          ...
          <!--/   INsert Modal start -->
          <div class="modal fade" id="staffModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
          ...
          <!-- start Update Model  -->
          <div class="modal fade" id="edit_staffModal" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                  ...
                  <div class="modal-body">
                    <form id="edit_staffForm" method="POST" action="" >
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="staff">Staff Name </label>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('#staffForm').submit(function(e) {
          ...
          $.ajax({
              type: 'POST',
              url: 'staffOperation.php?action=create_staff',
              data: $(this).serialize(),
              dataType: "json",
      ...
      $(document).on('click', '.editBtn', function() {
          ...
          $('#edit_id').val(staffData.id);
          $('#edit_staff_name').val(staffData.name);
          $('#edit_gender').val(staffData.gender);
          $('#edit_position').val(staffData.position);
          $('#edit_phone_number').val(staffData.phone_number);
          $('#edit_address').val(staffData.address);
          $('#edit_email').val(staffData.email);
          
          $('#edit_staffModal').modal('show');
      });
      // Update this part in your JavaScript
      $('#edit_staffForm').submit(function(e) {
          e.preventDefault();
          ...
          const formData = {
              edit_id: $('#edit_id').val(),
              edit_staff_name: $('#edit_staff_name').val(),
          ...
          $.ajax({
              url: 'staffOperation.php?action=update_staff',
              method: 'POST',
              data: formData,
              dataType: 'json',
              ...
              complete: function() {
                  submitBtn.prop('disabled', false).html('Update staff');
              }
          });
      });
      ...
      $(document).on('click', '.deleteBtn', function() {
          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  $.ajax({
                      type: 'POST',
                      url: 'staffOperation.php?action=delete_staff',
                      data: { id: staff_id },
                      dataType: 'json',
                      success: function(res) {
                          if (res.status === 'success') {
      ...
      function displayData() {
          $.ajax({
              url: 'staffOperation.php?action=display_staff',
              dataType: 'json',
