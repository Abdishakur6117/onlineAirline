    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
        <div class="content-wrapper">
          <div class="body">
                  <label for="Employee">Staff:</label><br>
                  <input type="text" id="staff_name" placeholder="Enter Staff Name">
                  <button onclick="searchStaff()">Search</button>
                  <table id="staff_table" class=" display nowrap"  style="width:100%; display:none;">
                    <thead>
                    <tr>
                      <td>ID</td>
                      <td>Staff Name</td>
 ...
 <!-- scripts -->
  ...
  <script>
    ...
    function searchStaff() {
        const searchTerm = $('#staff_name').val();
    ...
    function report(id) {
        window.open('staff_print.php?id=' + id, '_blank');
    }
  </script>
