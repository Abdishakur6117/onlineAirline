                          ...
                          <div class="modal-body">
                                  <form id="edit_paymentForm" method="POST" action="">
                                    <div class="mb-3">
                                        ...
                                        <select name="edit_Appointment_id" id="edit_Appointment_id" class="form-control"  readonly>
                                          <option value="">--Select Appointment Name--</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="payment_method" class="form-label">payment_method</label>
                                        <select name="edit_payment_method" id="edit_payment_method" class="form-control" readonly >
                                          <option value="">--Select Payment Method--</option>
                                          <option value="cash">Cash</option>
                                          <option value="card">Card</option>
                                          <option value="online">Online</option>
                                    ...
                                    <div class="mb-3">
                                        <label for="transaction_id" class="form-label">Transaction ID</label>
                                        <input type="text" class="form-control" id="edit_transaction_id" name="edit_transaction_id" readonly >
                                    </div>
